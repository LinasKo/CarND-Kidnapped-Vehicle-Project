    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          const Eigen::MatrixX4d& particles = pf.m_particles;
          ...
          json msgJson;
          msgJson["best_particle_x"] = bestParticle[0];
          msgJson["best_particle_y"] = bestParticle[1];
          msgJson["best_particle_theta"] = bestParticle[2];

          //Optional message data used for debugging particle's sensing and associations
          msgJson["best_particle_associations"] = pf.getAssociations(maxIndex);
          msgJson["best_particle_sense_x"] = pf.getSenseX(maxIndex);
          msgJson["best_particle_sense_y"] = pf.getSenseY(maxIndex);
